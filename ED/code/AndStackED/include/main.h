...
#define MainNetValueSafeVin   80 // "base" when switching to 255 due to safe_vin
#define MainNetValueLowCurrentLimit 81 // "base" when switching to 255 due to page.LowCurrentLimitTo255
