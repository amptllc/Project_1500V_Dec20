...
#define SetOscLowCurrentLimitInmA   19
#define SetOscDeltaV                20
#define SetOscOVStartupDelay        21
#define SetOscAfterStartupDelay     22
#define SetOscLowCurrentOnlyDelay   23
