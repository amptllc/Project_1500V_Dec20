...
+------------------------------------------------------------------------------
*/
#ifndef RF_USB_LIBRARY_CONFIG_H
#define RF_USB_LIBRARY_CONFIG_H


/*
 *
 * Description:
 * This file is used to configures the USB library.
 * The definitions not needed in a project can be commented out.
 *
 *
 *             ********** IMPORTANT! *************
 *
 * If the  USB library are to be used, copy the rf_usb_library_config_template.h file
