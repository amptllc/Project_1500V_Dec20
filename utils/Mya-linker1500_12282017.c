...
ParameterBlock page8K __attribute__((__packed__)) __attribute__ ((aligned (1))) = {// 8K Parameter Block
  ...
  { 0, 0, 0, 0, 0, 0 }, // myMac
  {
    ...
    -0.000693, 0.0556, 0.613, -200 // -240 //+ 300.0
  ...
  1000,    // VoutLimit  threshold setting (Volts) to engage Over Voltage protection.
  23000,   // IoutLimitCout (milliseconds in protection mode due to Iout > IoutLimit)
  10000,    // IoutLimit -> threshold setting (milliAmps) to engage Over Current protection. 
...
int main(int argc, char **argv)
{
  ...
  INT16  VoutLimit = 1000;               // Vout Limit (Volts) if exceeded will trigger protection mode 
  INT16  IoutLimitCount = 23000;         // milliseconds to stay in protection mode (0 - 32767)
  INT16  IoutLimit = 10000;              // Iout Limit (milliAmps) if exceeded will trigger protection mode
  ...
  INT16  VoutLimit8K = 1000;   
  INT16  IoutLimitCount8K = 23000; 
  INT16  IoutLimit8K = 10000; 
